...
const STUB_DESCRIPTION =
  "Незабаром тут з’явиться підбірка. Логіку трендів підключимо пізніше.";

/** Заглушки; пізніше замінити на дані з власного API/запиту для ТРЕНДИВ. */
function getTrendStubBooks(): BookCardBook[] {
...
export function MagicalGuide1() {
  ...
  const books = useMemo(() => getTrendStubBooks(), []);
