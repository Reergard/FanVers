...
| `shared/carousel/BookScrollerCarousel.tsx` | Спільна горизонтальна карусель (стрілки, зірки, сенсорний свайп, drag мишкою). Без автопрокрутки в author works. Див. **LISTS_AND_CAROUSELS_FRONTEND.md**. |
