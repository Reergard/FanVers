...
**Навігація каруселі:** стрілки, зірки, сенсорний свайп (JS drag), перетягування мишкою на ПК; клік по картці зберігається без руху, після свайпу/drag — блокується (§1.5). Автопрокрутка **вимкнена** (на відміну від реклами). Див. **LISTS_AND_CAROUSELS_FRONTEND.md** §1.2–§1.5, §2.
...
*Останнє оновлення: 2026-06-30 (`AuthorWorks`, `BookScrollerCarousel`, сенсорний drag, без автопрокрутки).*
