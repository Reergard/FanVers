...
- горизонтальний скрол: сенсорний свайп (JS drag + axis-lock), перетягування мишкою на ПК; вертикальний скрол сторінки на мобільному не блокується;
...
Див. **LISTS_AND_CAROUSELS_FRONTEND.md** §1.2–§1.7.
