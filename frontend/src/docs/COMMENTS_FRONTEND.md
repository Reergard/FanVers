...
6. Помилка: 403 — `showError(detail ?? "У вас немає прав...")` (у т.ч. «потрібно прочитати розділ» з бекенду — **READING_PROGRESS_BACKEND.md** §6); інакше — `showError("Помилка при відправці коментаря: " + msg)`.
...
**Останнє оновлення:** 2026-05-24 (403 за відсутності прогресу читання; аналітика — 2026-03-21).
