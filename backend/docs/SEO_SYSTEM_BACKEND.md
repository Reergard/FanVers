...
**Єдине що впливає на SEO:** якість опису книги, який пише перекладач/автор. У формі можна зберегти до **900** символів; у мета-теги потрапляють перші **120** символів чистого тексту (`get_seo_snippet`). Рекомендація для авторів: починати опис зі змістовного тексту, а не з привітань чи емодзі. Див. також **BOOK_CREATE_UPDATE_BACKEND.md** §8.
