...
urlpatterns = [
    ...
    path('books/<slug:book_slug>/volumes/<int:volume_id>/delete/', delete_volume, name='delete_volume'),
    ...
    path('books/<slug:slug>/author-works/', author_other_works, name='author-other-works'),
